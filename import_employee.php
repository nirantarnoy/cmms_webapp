...
if(isset($_FILES['upload_data']) && $cusid > 0){
    ...
    while (($rowData = fgetcsv($file, 10000, ",")) !== FALSE) {
        ...
        if($chk > 0){
            ...
            $created_at = time();
            $sql = "INSERT INTO employee (prefix,fname,lname,position,period,customer_id,effective_date,email,mobile,existing_wp,created_at,created_by)
            VALUES ('$prefix','$val2','$val3','$val4','$val5','$cusid','$ef_date','$val7','$val8','$wp_status','$created_at','$userid')";
            //echo $sql;return;
