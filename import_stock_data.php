...
if (isset($_FILES['upload_data'])) {
    ...
    if (empty($errors) == true) {
        move_uploaded_file($file_tmp, "uploads/files/product_stock_import.csv");
        //echo "Success";
    } else {
        print_r($errors);
    }
...
$upfiles = 'product_stock_import.csv';
...
//    $val14 = trim($rowData[9]);
    ...
    $sql = "INSERT INTO product_stock (prod_code,prod_name,year,branch,promotion,issue_status)
           VALUES ('$val1','$val2','$val3','$val4','$val5',0)";
